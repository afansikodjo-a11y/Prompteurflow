  ...
  return (
    ...
    >
          ...
          {FILTER_LABELS.map((label, index) => (
            <span
              ...
              className={cn(
                ...
                index === 0 ? "bg-white text-black" : "bg-black/40 text-white",
              )}
            >
              {label}
            </span>
          ))}
          <span className="flex shrink-0 items-center gap-1 rounded-full bg-black/40 px-2.5 py-1 text-[10px] font-medium text-white/50">
      ...
      <div className="absolute bottom-5 left-1/2 -translate-x-1/2">
        <div className="flex size-12 items-center justify-center rounded-full bg-red-600 shadow-lg shadow-red-600/30">
